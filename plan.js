const PLAN={
 upper:{title:"Einheit 1 – Upper Body",subtitle:"Hypertrophie & Haltung",type:"strength",warmup:"3 Min. Bike + Band Pull Apart ×15 + leichter Cable Row ×12 + 1–2 Aufwärmsätze Press.",exercises:[
 ...
 lower:{title:"Einheit 3 – Lower + Core",subtitle:"Beine, Hüfte & Rumpf",type:"strength",warmup:"3 Min. Bike + Bodyweight Split Squat ×6/Seite + Glute Bridge ×10 + Squat ×8.",exercises:[
 ...
 full:{title:"Einheit 4 – Full Body + Power",subtitle:"Ganzkörper & funktionelle Kraft",type:"strength",warmup:"3 Min. Bike + Squat ×6 + Scapular Push-up ×8 + leichter Row ×8.",exercises:[
