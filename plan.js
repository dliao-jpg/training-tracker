const PLAN={
 upper:{title:"Montag – Upper Body",subtitle:"Hypertrophie & Haltung",type:"strength",warmup:"3 Min. Bike + Band Pull Apart ×15 + leichter Cable Row ×12 + 1–2 Aufwärmsätze Press.",exercises:[
 ...
 lower:{title:"Mittwoch – Lower + Core",subtitle:"Beine, Hüfte & Rumpf",type:"strength",warmup:"3 Min. Bike + Bodyweight Split Squat ×6/Seite + Glute Bridge ×10 + Squat ×8.",exercises:[
 ...
 full:{title:"Freitag – Full Body + Power",subtitle:"Ganzkörper & funktionelle Kraft",type:"strength",warmup:"3 Min. Bike + Squat ×6 + Scapular Push-up ×8 + leichter Row ×8.",exercises:[
 ...
 zone2a:{title:"Dienstag – Zone 2",subtitle:"Aerobe Basis",type:"cardio",defaults:{mode:"Zone 2",duration:45,rpe:4}},
 cardioSat:{title:"Samstag – Cardio",subtitle:"Zone 2 oder gelegentlich 4×4",type:"cardio",defaults:{mode:"Zone 2",duration:50,rpe:4}}
};